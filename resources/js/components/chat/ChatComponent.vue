<template>
    <div>
        <div class="chat_view_list">
                ...
                <div class="chat_view_list_inner_scrolled" id="chat_container" style="max-height: 70vh;" v-chat-scroll>
                    <div>
                        ...
                        <div :id="'target'+index" v-for="(conversation, index) in this.conversations"
                             v-bind:key="index">
                            <div
                                v-if="parseInt(conversation.from_id) != from_user.id && conversation.deleted_by_to == '0'"
                                ...
                                <div class="thumb mr_20">
                                    ...
                                    <a v-else-if="to_user.avatar_url" href="#"><img
                                        :src="baseUrl+ asset_type + to_user.avatar_url" alt=""/></a>
                                ...
                                <div class="chat_text_info_wraper d-flex align-items-center">
                                    <div class="chat_text_info">
                                        <div v-if="conversation.reply">
                                            <p class="reply_p" v-if="conversation.reply.message_type == 0">
                                                {{ conversation.reply.message }}</p>
                                        ...
                                        <div v-if="conversation.forward_from">
                                            ...
                                            <div class="reply_p audio-padding"
                                                ...
                                                <span>{{ __('chat.forwarded_message') }} : </span><br/>
                                                <audio :src="baseUrl+asset_type+'/'+conversation.forward_from.file_name"
                                                       controls></audio>
                                            </div>
                                            <div v-else-if="conversation.forward_from.message_type == 5"
                                                ...
                                                <video class="w-100 border-radius-25" controls>
                                                    <source
                                                        :src="baseUrl+asset_type+'/'+conversation.forward_from.file_name"
                                                        type="video/mp4"/>
                                                </video>
                                            </div>
                                            <div class="reply_p p-3"
                                                ...
                                                <img
                                                    ...
                                                    :src="baseUrl+conversation.forward_from.file_name"
                                                    alt=""
                                                />
                                        ...
                                        <div class="audio-padding" v-if="conversation.message_type == 4">
                                            <audio :src="baseUrl+asset_type+'/'+conversation.file_name"
                                                   controls></audio>
                                        </div>
                                        <div v-else-if="conversation.message_type == 5" class="p-3 w-100">
                                            <video class="w-100 border-radius-25" controls>
                                                <source :src="baseUrl+asset_type+'/'+conversation.file_name"
                                                        type="video/mp4"/>
                                            </video>
                                        </div>
                            ...
                            <div v-if="conversation.from_id == from_user.id" class="chat_single d-flex sender_chat"
                                ...
                                <div class="chat_text_info_wraper d-flex align-items-center">
                                    ...
                                    <div class="chat_text_info">
                                        <div v-if="conversation.reply">
                                            <p class="sender_reply_p" v-if="conversation.reply.message_type == 0">
                                                {{ conversation.reply.message }}</p>
                                ...
                                <div class="thumb">
                                    ...
                                    <a v-else-if="from_user.avatar_url" href="#"><img
                                        :src="baseUrl+asset_type+ from_user.avatar_url" alt=""/></a>
                                    <a v-else href="#"><img :src="baseUrl+asset_type+'/chat/images/spondon-icon.png'"
                                                            alt=""/></a>
                                </div>
                            </div>
                ...
                <form v-if="!to_user.blocked" v-on:submit.prevent="sendMessage" :class="{'pt-100px' : addPadding}">
                    <div class="chat_input_box d-flex align-items-center">
                        <div class="input_thumb">
                            ...
                            <img v-else-if="from_user.avatar_url" :src="baseUrl + asset_type + from_user.avatar_url"
                                 alt=""/>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                <button class="svg_send_button" @click="sendMessage">
            ...
            <span class="text-muted" v-if="typing">{{ to_user.first_name }} {{ __('chat.is_typing') }}...</span>
            <div class="mt-2 bg-white timer-display d-flex justify-content-between" v-if="record_status">
