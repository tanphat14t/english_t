    ...
    Amaz.uploader = {
        ...
        /*
                trigger: function (
                    ...
                    $.post(
                        "{{route('setting.media-manager.get_media_modal')}}",
                ...
                function (data) {
                    ...
                    $('[data-toggle="infixUploaderAddSelected"]').on(
                        "click",
                        function () {
                            // todo issue here
                            if (from === "input") {
        ...
        */
        ...
        initForInput: function () {
            $(document).on("click", '[data-toggle="infixUploader"]', function (e) {
                if (e.detail === 1) {
                    var elem = $(this);
        ...
        previewGenerate: function () {
            ...
            $('[data-toggle="infixUploader"]').each(function () {
                let $this = $(this);
        ...
        removeAttachment: function () {
            $(document).on("click", '.img_remove_btn', function () {
                ...
                let selected = $(this)
                    ...
                    .prev('[data-toggle="infixUploader"]')
                    .find(".selected_files")
                    .val()
                    .split(",")
                    .map(Number);
        ...
        sortImage: function () {
            $(".product_image_all_div").sortable({
                ...
                update: function (event, ui) {
                    ...
                    $(this).prev('[data-toggle="infixUploader"]').find('.selected_files').val(imageids.join(','));
                }
            });
        }
