...
@section('mainContent')
    ...
    <form action="{{ route('users.instructor_refund_make_request_store') }}" method="post"
        ...
        @php
            $e_items = [];
        @endphp
        <div class="white_box_50px box_shadow_white mb-20 col-md-10 mx-auto">
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach ($package->products as $k => $package_product)
                                    ...
                                    <input type="hidden" name='product_id' value="{{ $package_product->course->id }}">
                                    ...
                                    <tr>
                                                ...
                                                <span>
                                                    <label class="primary_checkbox d-flex"
                                                        ...
                                                        <input type="checkbox" name="product_ids[]"
                                                               id="product_id{{ $package_product->id }}" checked
                                                               value="{{ $package->id }}-{{ $package_product->qty }}-{{ $package->seller_id }}-{{ $package_product->price }}-{{ $package_product->course->id }}">
                                        ...
                                        <td colspan="2" style="text-align: left">
                                            <h5 class="black_color">
                                                {{ @$package_product->course->title }}
                                            </h5>
                                        </td>

                                        <td class="black_color">
                                            {{ getPriceFormat($package_product->price) }}
                                        </td>
                                        <td class="black_color">
                                            {{ $package_product->qty }}
                                        </td>
                                        ...
                                        <td style="text-align: left" class="black_color">
                                            <select class="primary_select wide rounded-0" required
                                                    id="reason_{{ $package_product->course->id }}"
                                                    name="reason_{{ $package_product->course->id }}">
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-15">
                        <label class="primary_input_label" for="">{{__('product.additional_information')}}</label>
                    ...
                    <div class="bank_info_div d-none">
                        ...
                        <div class="primary_input mb-3">
                            ...
                            <input class="primary_input_field" id="bank_name" name="bank_name"
                                   placeholder="{{__('product.bank_name')}}" type="text" value="{{old('bank_name')}}">
                        </div>
                        <div class="primary_input mb-3">
                            ...
                            <div class="img_upload_group d-flex align-items-center">
                                <label for="photo_12" class="photo_uploader">
                                    ...
                                    <input class="d-none upload_img_for_product" type="file" id="photo_12"
                                           ...
                                           data-upload_div="#img_upload_div_12" data-count="#count_12" max="6" multiple>
                                </label>
                ...
                <div class="col-lg-12 text-center">
                    <button class="primary_btn_2 mt-2"><i class="ti-check"></i>{{__('product.send')}} </button>
                </div>
