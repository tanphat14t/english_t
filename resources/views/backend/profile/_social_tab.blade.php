                    ...
                    <div class="col-xl-12 mt-repeater no-extra-space">
                        ...
                        <div data-repeater-list="instant_messaging">
                            @foreach($instant_messages as $i_msg)
                                <div data-repeater-item class="mt-repeater-item">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="primary_input mb-25">
                                            <label class="primary_input_label" for="service"> {{__('profile.service')}} </label>
                                            <input name="service" value="{{$i_msg->service}}"  class="primary_input_field service"  placeholder="Ex: Skype" type="text">
                                        </div>
                                    </div>

                                    <div class="col-lg-4">
                                        <div class="primary_input mb-25">
                                            <label class="primary_input_label" for="username"> {{__('profile.username')}}  </label>
                                            <input name="username"  value="{{$i_msg->username}}"  class="primary_input_field username"  placeholder="Ex: jon" type="text">
                                        </div>
                                    </div>
                                ...
                                <div class="mt-repeater-row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="service"> {{__('profile.service')}} </label>
                                                <input name="service"  class="primary_input_field service"  placeholder="Ex: Skype" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="username"> {{__('profile.username')}}  </label>
                                                <input name="username"  class="primary_input_field username"  placeholder="Ex: jon" type="text">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <a href="javascript:void(0);" data-repeater-create class="primary-btn radius_30px  fix-gr-bg mt-repeater-add "><i class="fa fa-plus"></i>{{__('common.Add More')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
