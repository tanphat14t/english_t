                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input id="facebook" name="facebook" placeholder="{{__('common.Facebook URL')}}"
                               ...
                               class="primary_input4" {{$errors->first('facebook') ? 'autofocus' : ''}}
                ...
                <div class="row mt_20">
                    <div class="col-lg-6">
                        ...
                        <input id="twitter" name="twitter" placeholder="{{__('common.Twitter URL')}}"
                               ...
                               class="primary_input4" {{$errors->first('twitter') ? 'autofocus' : ''}}
                ...
                <div class="row mt_20">
                    <div class="col-lg-6">
                        ...
                        <input id="linkedin" name="linkedin" placeholder="{{__('common.LinkedIn URL')}}"
                               ...
                               class="primary_input4" {{$errors->first('linkedin') ? 'autofocus' : ''}}
                ...
                <div class="row mt_20">
                    <div class="col-lg-6">
                        ...
                        <input id="instagram" name="instagram" placeholder="{{__('common.Instagram URL')}}"
                               ...
                               class="primary_input4" {{$errors->first('instagram') ? 'autofocus' : ''}}
                    ...
                    <div class="col-xl-12 mt-repeater no-extra-space">
                                ...
                                <div data-repeater-item class="mt-repeater-item">
                                    ...
                                    <div class="col-lg-1">
                                        <div class="position-relative form-group ">
                                            <a  href="javascript:void(0);" data-repeater-delete class="link_value theme_btn small_btn4 mt_32  mt-repeater-delete">
                            ...
                            <div data-repeater-item class="mt-repeater-item">
                                ...
                                <div class="mt-repeater-row">
                                    ...
                                    <div class="row mt_20">
                                        ...
                                        <div class="col-lg-1">
                                            <div class="position-relative form-group ">
                                                <a  href="javascript:void(0);" data-repeater-delete class="link_value theme_btn small_btn4 icon-only  mt_32  mt-repeater-delete">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <a href="javascript:void(0);" data-repeater-create class="link_value theme_btn small_btn4 radius_30px  mt-repeater-add "><i class="fa fa-plus mr-1"></i>{{__('common.Add More')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
