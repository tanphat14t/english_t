                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input id="title" name="title" placeholder="EX: Sales Manager"
                                   ...
                                   class="primary_input4" {{$errors->first('institution') ? 'autofocus' : ''}}
                        ...
                        <div class="col-lg-12 mt_20">
                            ...
                            <input id="company_name" name="company_name" placeholder="EX: Aorasoft"
                                   ...
                                   class="primary_input4" {{$errors->first('company_name') ? 'autofocus' : ''}}
                        ...
                        <div class="col-lg-6 mt_20">
                            ...
                            <input id="start_date" name="start_date" placeholder="Date"
                        ...
                        <div class="col-lg-6 mt_20 end_date_div">
                            ...
                            <input id="end_date" name="end_date" placeholder="Date"
                                   class="primary_input4"
