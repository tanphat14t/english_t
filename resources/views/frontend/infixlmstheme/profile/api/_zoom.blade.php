            ...
            <div class="row mt_20">
                <div class="col-lg-6">
                    ...
                    <input id="zoom_account_id" name="zoom_account_id" placeholder="{{__('zoom.Account ID')}}"
                           ...
                           class="primary_input4" {{$errors->first('zoom_account_id') ? 'autofocus' : ''}}
            ...
            <div class="row mt_20">
                <div class="col-lg-6">
                    ...
                    <input id="zoom_client_id" name="zoom_client_id" placeholder="{{__('zoom.Client ID')}}"
                           ...
                           class="primary_input4" {{$errors->first('zoom_client_id') ? 'autofocus' : ''}}
            ...
            <div class="row mt_20">
                <div class="col-lg-6">
                    ...
                    <input id="zoom_client_secret" name="zoom_client_secret" placeholder="{{__('zoom.Client secret')}}"
                           ...
                           class="primary_input4" {{$errors->first('zoom_client_secret') ? 'autofocus' : ''}}
