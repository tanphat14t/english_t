                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input id="current_password" name="current_password"
                               ...
                               class="primary_input4" {{$errors->first('current_password') ? 'autofocus' : ''}}
                               type="password">
                ...
                <div class="row mt_20">
                    <div class="col-lg-6">
                        ...
                        <input id="new_password" name="new_password"
                               ...
                               class="primary_input4" {{$errors->first('new_password') ? 'autofocus' : ''}}
                               type="password">
                ...
                <div class="row mt_20">
                    <div class="col-lg-6">
                        ...
                        <input id="confirm_password" name="confirm_password"
                               ...
                               class="primary_input4" {{$errors->first('confirm_password') ? 'autofocus' : ''}}
                               type="password">
