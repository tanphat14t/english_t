        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('users.skills.store')}}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label class="primary_label2" for="skills"> {{ __('profile.skills') }} <span class="text-danger">[Note: seperated by " , "]</span></label>
                            <input id="skills" name="skills" placeholder="{{__('common.Name')}}" data-role="tagsinput"
                                   onfocus="this.placeholder = ''"
                                   onblur="this.placeholder = '{{ __('profile.skills') }}'"
                                   class="primary_input4" {{$errors->first('skills') ? 'autofocus' : ''}}
