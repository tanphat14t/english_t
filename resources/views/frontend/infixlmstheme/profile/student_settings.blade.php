    ...
    <section class="main_content_iner main_content_padding">
        <div class="box_header">
            <div class="main-title align-items-center flex-wrap d-flex mb_30">
                <h3 class="mb-0 font-weight-bold">{{__('profile.profile_settings')}}</h3>
                <div class="d-flex align-items-center ml-auto pr-0 pr-lg-4">
                    <p class="mb-0 mr-3">{{ __('profile.active_offline_status') }}</p>
                    <label class="lmsSwitch_toggle d-flex align-items-center ml-auto" for="autoNext">
