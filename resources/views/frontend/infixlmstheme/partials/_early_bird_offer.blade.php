    ...
    @foreach ($price_plans as $price_plan)
        ...
        @if ($is_eligible)
            <div class="pb-3 ">
                ...
                <label class="primary_bulet_checkbox d-flex select_price_plan">
                    ...
                    <div class=" d-flex flex-column">
                        ...
                        <span class="font-14 text-gray">
                            @php
                                if ($price_plan->capacity != null) {
                                    $capacity = _trans('price_plan.For first :capacity students');
                                    $capacity = str_replace(':capacity', $price_plan->capacity, $capacity);
                                } else {
                                    $capacity = '';
                                }
                            @endphp
