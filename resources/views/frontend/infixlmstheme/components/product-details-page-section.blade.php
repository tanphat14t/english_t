                ...
                <div class="shop-details bg-white">
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="shop-details-nav" id="shop-gallery">
                ...
                <div class="shop-info">
                    <div class="course-details-info bg-white mb-0">
                        <ul class="nav nav-pills rounded-0">
                            <li class="nav-item">
                                <button class="nav-link active" data-toggle="tab" data-target="#overview"
                                        type="button" aria-selected="true"
                                        aria-controls="overview">{{ __('product.Description') }}</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-toggle="tab" data-target="#curriculum" type="button"
                                        aria-selected="false"
                                        aria-controls="curriculum">{{ __('frontend.Additional Information') }}</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-toggle="tab" href="#instructor" type="button"
                                        aria-selected="false"
