                    ...
                    <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="description_grid">
                                                    ...
                                                    <div class="single_description_grid">
                                                        ...
                                                        {{--                                                        @endphp--}}
                                                        <p class="nowrap"> {{convertMinutesToHourAndMinute($course->class->duration * ($course->class->total_class??1))}} {{__("frontend.Hours")}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="sidebar__widget mb_30">
                                ...
                                @if($showWaitList)
                                    <a type="button" data-toggle="modal" data-target="#courseWaitList"
                                       class="theme_btn d-block text-center height_50 mb_10">
                                ...
                                <ul class="course_includes">
                                    ...
                                    <li>
                                        <i class="ti-timer"></i>
                                        <p class="nowrap"> {{ __('frontend.Duration') }} {{convertMinutesToHourAndMinute($course->class->duration * ($course->class->total_class??1))}}
                                            {{__('frontend.Hours')}}</p>
                                    </li>
