                                        ...
                                        <div class="table-responsive mb-5 mt-5">
                                            <table class="table amazy_table3 style2 mb-0">
                                                ...
                                                @foreach ($refund_detail->refund_products as $key => $refund_product)
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{{ courseDetailsUrl(@$refund_product->course->id, @$refund_product->course->type, @$refund_product->course->slug) }}"
                                                               class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                <div class="thumb">
                                                                    <img class="img-fluid"
                                                                         src="{{ getCourseImage($refund_product->course->image) }}"
                                                                         alt="" title="">
                                                                </div>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <div class="summery_pro_content">
                                                                <h5 class="font_16 f_w_700 text-nowrap m-0 theme_hover">{{ @$refund_product->course->title }}</h5>
                                                        ...
                                                        <td>
                                                            <h5 class="font_16 f_w_500 m-0 text-nowrap">
                                                                @php
                                                                    if ($refund_product->course->discount_price != null) {
                                                                        $price = $refund_product->course->discount_price;
                                                                    } else {
                                                                        $price = $refund_product->course->price;
                                                                    }
                                                                @endphp
                ...
                <form action="{{route('frontend.my_purchase_order_package_cancel')}}"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{__('product.Close')}}
                        </button>
                        <button type="submit"
