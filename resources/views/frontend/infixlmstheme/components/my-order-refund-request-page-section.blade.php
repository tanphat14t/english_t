                                                        ...
                                                        <div class="d-flex flex-column  ">
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('product.order_id')}}
                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base"> {{ @$package->order->order_number }}</p>
                                                            </div>
                                                            @if(isModuleActive('MultiVendor'))
                                                                <div class="d-flex align-items-center flex-wrap gap_5">
                                                                    <h4 class="font_14 f_w_500 m-0 lh-base">{{__('product.seller')}}
                                                                        : </h4>
                                                                    <p class="font_14 f_w_400 m-0 lh-base"> {{($package->seller_id != 1)?@$package->seller->sellerAccount->seller_shop_display_name:app('general_setting')->site_title}}</p>
                                                                </div>
                                                            @endif
                                                        </div>
                                                        <div class="d-flex flex-column ">
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.Status')}}
                                                                    : </h4>
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('product.order_date')}}
                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base"> {{ $package->created_at }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column">
                                                            @php
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('product.order_amount')}}
                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base"> {{ single_price($grand_total) }}</p>
                                                            </div>
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('product.payment')}}
                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base">
                                                        ...
                                                        <div class="dashboard_white_box_body">
                                                            <div class="table-responsive mb_10">
                                                                <table
                                                                    ...
                                                                    <input type="hidden" name="package_id"
                                                                           value="{{ $package->id }}">
                                                                    @foreach ($package->products as $k => $package_product)

                                                                        @php
                                                                            $e_items[]=[
                                                                                "item_id"=>$package_product->course->id,
                                                                                "item_name"=> $package_product->course->title,
                                                                        ...
                                                                        <input type="hidden" name='product_id'
                                                                               value="{{ $package_product->course->id }}">
                                                                        <tr>
                                                                            <td>
                                                                                <a href="{{ courseDetailsUrl(@$package_product->course->id, @$package_product->course->type, @$package_product->course->slug) }}"
                                                                                   class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                                    <label
                                                                                        ...
                                                                                        for="product_id{{ $package_product->id }}">
                                                                                        <input type="checkbox"
                                                                                               name="product_ids[]"
                                                                                               id="product_id{{ $package_product->id }}"
                                                                                               checked
                                                                                               value="{{ $package->id }}-{{ $package_product->product_sku_id }}-{{ $package->seller_id }}-{{ $package_product->price }}-{{ $package_product->course->id }}">
                                                                                        <span class="checkmark"></span>
                                                                                    </label>
                                                                                    <div class="thumb">
                                                                                        <img
                                                                                            src="{{getCourseImage(@$package_product->course->product->thumbnail)}}"
                                                                                            alt="">
                                                                                    </div>
                                                                                    <div class="summery_pro_content">
                                                                                        <h4 class="font_16 f_w_700 m-0 theme_hover">{{ @$package_product->course->product->product_name,30 }}</h4>

                                                                                    </div>
                                                                                </a>
                                                                            </td>
                                                                            <td>
                                                                                <h4 class="font_16 f_w_500 m-0 text-nowrap">{{ $package_product->qty }}
                                                                                    X {{ getPriceFormat($package_product->price) }}</h4>
                                                                            </td>
                                                                            <td>
                                                                                <div
                                                                                    class="product_number_count style_4"
                                                                                    data-target="amount-1">
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        type="text"
                                                                                        name="qty_{{ $package_product->product_sku_id }}"
                                                                                        maxlength="{{ $package_product->qty }}"
                                                                                        minlength="1"
                                                                                        value="{{ $package_product->qty }}"
                                                                                        readonly>
                                                                                    <button type="button" value="+"
                                                                            ...
                                                                            <td>
                                                                                <select
                                                                                    ...
                                                                                    required
                                                                                    id="reason_{{ $package_product->product_sku_id }}"
                                                                                    name="reason_{{ $package_product->product_sku_id }}">
                                                            ...
                                                            <form action="#">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <label
                                                                            class="primary_label2 style2 ">{{__('product.set_prefered_option')}} </label>
                                                                        <select
                                                                            class="theme_select wide rounded-0 mb_30"
                                                                            name="money_get_method"
                                                                            id="money_get_method">
                                                                            <option
                                                                                value="wallet">{{__('product.wallet')}}</option>
                                                                            <option
                                                                                value="bank_transfer">{{__('product.bank_transfer')}}</option>
                                                                        </select>
                                                                        <div class="bank_info_div row d-none">
                                                                            <div class="col-md-12">
                                                                                <h5>{{__('product.bank_information_to_recieve_money')}}</h5>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <label
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <label
                                                                            class="primary_label2 style2 ">{{__('product.set_shipment_option')}} </label>
                                                                        <select
                                                                            class="theme_select wide rounded-0 mb_30"
                                                                            name="shipping_way" id="shipping_way">
                                                                            <option
                                                                                value="courier">{{ __('product.courier_pick_up') }}</option>
                                                                            <option
                                                                                value="drop_off">{{ __('product.drop_off') }}</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    @foreach (auth()->user()->customerAddresses as $key_num => $address)
                                                                                        <option
                                                                                            value="{{ $address->id }}">{{ $address->address1 }}
                                                                                            , {{ @$address->city }}
