                    ...
                    <div class="fourm_header d-flex align-items-center justify-content-between">
                        ...
                        {{-- <div class="fourm_header_right">
                            <div class="nav fouram_tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Unread</a>
                                ...
                                <a class="nav-link" id="nav-contact-tab2" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact2" aria-selected="false">Most Liked</a>
                            </div>
                        </div> --}}
                    </div>
                                    ...
                                    <form class="new_post_form" method="post" action="{{ route('forum.storeForum') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input name="title" placeholder="Title" onfocus="this.placeholder = ''"
