                            ...
                            <div class="support_main_details_info">
                                ...
                                <form action="{{ route('student.ticket.message') }}" method="post"
                                    ...
                                    <div class="support_main_details_info_textarea">
                                        ...
                                        <textarea class='primary_input4 editor' name="text" id="" cols="30"
                                                  rows="10"
                                    ...
                                    <div class="row align-items-center">
                                                    ...
                                                    <div class="col-11">
                                                        <div class="support_main_card_content_item">
                                                            ...
                                                            <div
                                                                ...
                                                                <input type="text"
                                                                       class="primary_input4 filePlaceholder"
                                        ...
                                        <div
                                                class="col-xl-5 col-lg-12 col-md-5 text-right mobile-center mt-md-5">
