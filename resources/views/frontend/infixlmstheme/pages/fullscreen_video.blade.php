...
@section('mainContent')
                                ...
                                <div class="contact_wrap d-flex align-items-center flex-wrap mx-0">
                                    <div class="contact_btn d-flex align-items-center flex-wrap">
                                        @if (in_array($lesson->host, $video_lesson_hosts))
                                            <button
                                                class="theme_btn small_btn2 p-2 mr-2 mr-lg-4 fs-14 completeAndPlayNext">
                                        ...
                                        @if (isset($lessons))
                                            <div class="d-flex aling-items-center">
                                                ...
                                                <span class="pl-2 text-nowrap">{{ __('frontend.Auto Next') }}</span>
                                            </div>
                                            <div class="pl-20 text-right ml-3 d-flex align-items-center">
                                                ...
                                                @if (0 == array_search($current_page, $lesson_ids))
                                                    <a href="#" disabled="disabled"
                                                       class="header__common_btn theme_button_disabled disabled">
                                                        ...
                                                        {{-- <span class="d-none d-md-inline-block">{{ __('frontend.Previous') }}</span> --}}
                                                    </a>
                                                @else
                                                    <a href="#"
                                                ...
                                                @if (array_search($current_page, $lesson_ids) < array_search(end($lesson_ids), $lesson_ids))
                                                    <a href="#" id="next_lesson_btn"
                                                       onclick="goFullScreen({{ $course->id }},{{ $lesson_ids[$current_index + 1] }})"
                                                       class="header__common_btn ml-2">
                                                        <i class="fa fa-angle-right"></i>
                                                        {{-- <span class="d-none d-md-inline-block">{{ __('frontend.Next') }}</span> --}}
                                                    </a>
                                                @else
                                                    <a href="#" disabled
                                                       class="header__common_btn theme_button_disabled ml-2 disabled"
                                                       style="opacity: 1">
                                                        <i class="fa fa-angle-right"></i>
                                                        {{-- <span class="d-none d-md-inline-block">{{ __('frontend.Next') }}</span> --}}
                                                    </a>
                                        ...
                                        <a href="javascript:void(0)" class="ml-2 mobile_progress">
                                        ...
                                        {{-- <a href="#" data-toggle="modal" data-target="#ShareLink" class="theme_btn small_btn2 p-2 ml-1">
                                            <i class="fa fa-share"></i> <span class="d-none d-md-inline-block">{{ __('frontend.Share') }}</span>
                                        </a> --}}
                                        <div class="header__common_btn dropdown ml-2">
                                            <button
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#" data-toggle="modal"
                                                       data-target="#ShareLink"><i
                                                            class="fa fa-share fs-12 mr-2"></i>{{ __('frontend.Share') }}
                                                    </a></li>
                                                @if (Auth::check())
                                                    @if (Auth::user()->role_id == 3)
                                                        @if (!in_array(Auth::user()->id, $reviewer_user_ids))
                                                            <li>
                                                                <a href="#" data-toggle="modal"
                                                                   data-target="#courseRating" class="dropdown-item">
                                                                    <i class="fa fa-star mr-2 fs-12"></i>{{ __('frontend.Leave a rating') }}
                                                                </a>
                                                            </li>
                                                        @endif
                                                    @endif
    ...
    <div class="course_fullview_wrapper">
        ...
        @endphp --}}
        {{-- @if (in_array($lesson->host, $video_lesson_hosts))
            <button class="theme_btn small_btn2 p-2 top_right_btn completeAndPlayNext">
                {{ __('frontend.Mark as Complete') }}</button>
        @endif --}}
        @if ($lesson->is_quiz == 1)
            @if (count($result) != 0)
        ...
        <div class="floating-title position-fixed">
            <p class="font_16 d-flex align-items-center">
                <span class="header__common_btn mr-2 play_toggle_btn"><i
        ...
        <div class="course__play_warp courseListPlayer ">
            <div class="play_warp_header d-flex justify-content-between">
                <h3 class="font_16 mb-0 lesson_count default-font d-flex align-items-center">
                    <span class="play_toggle_btn header__common_btn mr-2 d-none d-lg-flex">
                                ...
                                @if ($percentage >= 100)
                                    @if (isModuleActive('Survey') && $course->survey)
                                            ...
                                            @if (auth()->user()->attendSurvey($course->survey))
                                                ...
                                                @if (isModuleActive('MyClass'))
                                                    <a href="{{ route('get-transcript', [$course->id, auth()->user()->id]) }}"
                                                       class="theme_btn certificate_btn mt-5 mb-5 ml-2"
                                        ...
                                        @else
                                            @if (!auth()->user()->attendSurvey($course->survey))
                                                <button type="button" data-toggle="modal" data-target="#assignSubmit"
                                                        class="theme_btn certificate_btn mt-5 mb-5 mr-1">
                                                    {{ __('frontend.Survey') }}
                                                </button>
                                            @endif
                                            <a href="{{ route('getCertificate', [$course->id, $course->title]) }}"
                                               class="theme_btn certificate_btn mt-5 mb-5 ml-1">
                                                {{ __('frontend.Get Certificate') }}
                                            </a>
                                            @if (isModuleActive('MyClass'))
                                                <a href="{{ route('get-transcript', [$course->id, auth()->user()->id]) }}"
...
@push('js')
    ...
    @if ($lesson->host == 'Self' || $lesson->host == 'AmazonS3' || $lesson->host == 'URL' || $lesson->host == 'Storage')
        <script>
