                                                ...
                                                <div class="forum_replay_single">
                                                    ...
                                                    <div
                                                        ...
                                                        <form action="{{route('forum.ForumReplyUpdate')}}"
                                                            ...
                                                            <button type="submit"
                                                                    class="theme_btn small_btn5 text-right mt-2">Update
                                                            </button>
                                                        </form>
                                                    </div>
                                                    {{-- End Reply Update --}}
                                                        ...
                                                        <div class="forum_right">
                                                            @if ($forum->is_closed!=1)
                                                                <a data-toggle="collapse"
                                                                   data-target=".reply_{{$reply->id}}" href="#"
                                                            ...
                                                            @endif
                                                            <a data-toggle="modal"
                                                               data-target="#replyDelete{{$reply->id}}" href="#"> <img
                                                        ...
                                                        <div class="forum_replay_single">
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{route('forum.RepliesReplyUpdate')}}"
                                                                    ...
                                                                    <button type="submit"
                                                                            class="theme_btn small_btn5 text-right mt-2">
                                                                        Update
                                                                    </button>
                                                                </form>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="forum_right">
                                                                    @if ($forum->is_closed!=1)
                                                                        <a data-toggle="collapse"
                                                                           data-target=".second_reply_{{$second_reply->id}}"
                                                                           href="#"
                                                                    ...
                                                                    @endif
                                                                    <a data-toggle="modal"
                                                                       data-target="#secondReplyDelete{{$second_reply->id}}"
                                                                       href="#"> <img
                                                                                src="{{asset('Modules/Forum/Resources/assets/img/trash.svg')}}"
                                                                                alt="#"> Delete</a>
                                                    ...
                                                    <div class="commnet_replay_box flex-fill">
                                                        <form action="{{route('forum.ForumReply')}}" method="post">
                                                            ...
                                                            <textarea class="primary_textarea3 style3 forum_reply"
                                                                      ...
                                                                      placeholder="Write your reply here"></textarea>
                                                            <button type="submit"
                                                                    class="theme_btn small_btn5 text-right mt-2">Reply
                                                            </button>
                                                        </form>
                                                    </div>
                                                </div>
