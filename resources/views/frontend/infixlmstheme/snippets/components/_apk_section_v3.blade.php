            ...
            <div class="row apk-skill">
                <div class="col-md-6">
                    <div class="apk-skill-card">
                        ...
                        <div class="apk-skill-img"><img src="{{themeAsset('img/others/apk-card-1.png')}}" alt=""></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="apk-skill-card">
                        ...
                        <h3>Level - Up Your Raw Coding <br> Skills in Lockdown</h3>
                        <a href="#" class="theme-btn">Find Out More</a>
                        <div class="apk-skill-img"><img src="{{themeAsset('img/others/apk-card-2.png')}}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
