                                    ...
                                    <div
                                        ...
                                        <div class="featured-info bg-primary">
                                            ...
                                            <span class="d-flex align-items-center justify-content-center"><i
                                                    class="fa text-orange fa-star me-2"></i>{{$course->totalReview}} ({{$course->total_rating}} {{__('frontend.Rating')}})</span>
                                            <span class="d-flex align-items-center justify-content-center"><i
                                                    class="fa text-primary fa-user me-2"></i>{{$course->total_enrolled}} {{__('frontend.Students')}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7">
