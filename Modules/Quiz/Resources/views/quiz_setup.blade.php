    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        <div class="container-fluid p-0">
            <div class="row">
                ...
                @if($advance)
                    <div class="advance_quiz col-lg-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <h3 class="mb-30">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-{{$top}} ">
                                                <ul class="permission_list">
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="difficulty_level_status"
                                                                   ...
                                                                   @endif value="1"
                                                                   id="difficulty_level_status" type="checkbox">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <label
                                                    ...
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="auto_generate_quiz_code_status"
                                                                   ...
                                                                   @endif value="1"
                                                                   id="auto_generate_quiz_code_status" type="checkbox">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <label
                                                    ...
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="auto_generate_quiz_offline_testing_status"
