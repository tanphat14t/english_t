    ...
    public function PageContentUpdate(Request $request)
    {
        ...
        try {
            ...
            if ($request->blog_page_banner != null) {
                $item = HomeContent::where('key', $request->blog_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
            ...
            if ($request->about_page_banner != null) {
                $item = HomeContent::where('key', $request->about_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->instructor_page_banner != null) {
                $item = HomeContent::where('key', $request->instructor_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->become_instructor_page_banner != null) {
                $item = HomeContent::where('key', $request->become_instructor_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->quiz_page_banner != null) {
                $item = HomeContent::where('key', $request->quiz_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->class_page_banner != null) {
                $item = HomeContent::where('key', $request->class_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->course_page_banner != null) {
                $item = HomeContent::where('key', $request->course_page_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if ($request->saas_banner != null) {
                $item = HomeContent::where('key', $request->saas_banner)->first();
                if ($item) {
                    $item->value = null;
                    $item->save();
                    $this->removeLink($item->id, get_class($item));
            ...
            if (isModuleActive('Subscription')) {
                ...
                if ($request->subscription_page_banner != null) {
                    $item = HomeContent::where('key', $request->subscription_page_banner)->first();
                    if ($item) {
                        $item->value = null;
                        $item->save();
                        $this->removeLink($item->id, get_class($item));
