                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class=" mb-25">
                                                                <x-upload-file
                                                                    ...
                                                                    type="image"
                                                                    media_id="{{isset($edit)?$edit->value_media?->media_id:''}}"
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class=" mb-25">
                                                            <x-upload-file
                                                                ...
                                                                type="image"
                                                                media_id="{{isset($edit)?$edit->value_media?->media_id:''}}"
                                                                label="{{ __('forum.frontendmanage.Blog Page Banner') }}"
                                                                note="{{__('student.Recommended size')}} (1920x500)"
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class=" mb-25">
                                                            <x-upload-file
                                                                ...
                                                                type="image"
                                                                media_id="{{isset($edit)?$edit->value_media?->media_id:''}}"
                                                                label="{{ __('forum.frontendmanage.Saas Plan Banner') }}"
                                                                note="{{__('student.Recommended size')}} (1920x500)"
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class=" mb-25">
                                                            <x-upload-file
                                                                ...
                                                                type="image"
                                                                media_id="{{isset($edit)?$edit->value_media?->media_id:''}}"
                                                                label="{{ __('forum.frontendmanage.Offer Page Banner') }}"
                                                                note="{{__('student.Recommended size')}} (1920x500)"
                                                            />
                                                        </div>
                                                    </div>
