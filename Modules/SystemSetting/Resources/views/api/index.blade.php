            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="payment_getway_tab ">
                        <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-10 ml-0" role="tablist">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link "
                                   href="#googleFont"
                                   role="tab" data-toggle="tab">{{__('setting.Google')}} {{__('setting.Fonts')}}</a>
                            </li>
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link"
                                   href="#exchangerate"
                                   role="tab" data-toggle="tab">{{__('setting.Exchangerate')}}</a>
                            </li>
