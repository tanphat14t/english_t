                ...
                if (isset($course) && isset($chapter)) {
                    ...
                    if (isset($course->enrollUsers) && !empty($course->enrollUsers)) {
                        foreach ($course->enrollUsers as $user) {
                            ...
                            if (UserSmsNotificationSetup('Course_Quiz_Added', $user)) {

                                send_sms_notification($user, $type = 'Course_Quiz_Added', $shortcodes = [
                                    'time' => Carbon::now()->format('d-M-Y, g:i A'),
                                    'course' => $course->title,
                                    'chapter' => $chapter->name,
                                    'quiz' => $quiz->title,
                    ...
                    if (UserSmsNotificationSetup('Course_Quiz_Added', $courseUser)) {
                        send_sms_notification($courseUser, $type = 'Course_Quiz_Added', $shortcodes = [
                            'time' => Carbon::now()->format('d-M-Y, g:i A'),
                            'course' => $course->title,
                            'chapter' => $chapter->name,
                            'quiz' => $quiz->title,
