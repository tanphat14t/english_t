        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form action="{{route('updateSmsMessage')}}" method="post">
                            @csrf
                            <input type="hidden" name="id"
                                   value="{{@$template->id}}">
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="primary_input mb-35">
                                        ...
                                        <textarea id="my-textarea" class="primary_input_field" style="height: 200px"
                                                  name="sms_message" cols="30"
                                                  rows="20">{{$template->sms_message}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12 text-center pt_15">
                                    <div class="d-flex justify-content-center">
