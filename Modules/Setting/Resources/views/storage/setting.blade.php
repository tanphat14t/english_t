                ...
                <div class="col-12">
                    <form action="{{route('setting.media-manager.settingUpdate')}}" method="POST" id="DefaultStorage">
                            ...
                            <ul id="" class="permission_list sms_list">
                                @foreach ($cloud_hosts as $key => $host)
                                    <li class="d-flex align-items-center justify-content-center">
                                        ...
                                        <label class="pt-2" for="active_storage{{ $key }}">{{ $host }}</label>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        @if(isModuleActive('AmazonS3'))
                            <div class="col-xl-12 cloud-form d-none" id="AmazonS3Form">
                                @include('amazons3::_form')
                            </div>
                        @endif
                        @if(isModuleActive('BunnyStorage'))
                            <div class="col-xl-12 cloud-form d-none" id="BunnyStorageForm">
                                @include('bunnystorage::_form')
                            </div>
                        @endif
                        <div class="col-xl-12 cloud-form d-none" id="GoogleDriveForm">
                            @includeIf('setting::storage.partials._gdrive_form')
                        </div>

                        @if(isModuleActive('Storage'))
                            <div class="col-xl-12 cloud-form d-none" id="DigitalOceanForm">
                                @include('storage::_digital_ocean_form')
                            </div>

                            <div class="col-xl-12 cloud-form d-none" id="WasabiForm">
                                @include('storage::_wasabi_form')
                            </div>

                            <div class="col-xl-12 cloud-form d-none" id="BackblazeForm">
                                @include('storage::_backblaze_form')
                            </div>

                            <div class="col-xl-12 cloud-form d-none" id="DropboxForm">
                                @include('storage::_dropbox_form')
                            </div>

                            <div class="col-xl-12 cloud-form d-none" id="ContaboForm">
