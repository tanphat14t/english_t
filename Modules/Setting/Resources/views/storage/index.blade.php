                                            ...
                                            <div class=" col-md-9  float-right">
                                                <div class=" d-flex align-content-center justify-content-end">
                                                    <div class="primary_input m-2 ">
                                                        <select class="primary_select " name="sort" id="status">
                                                            <option value="newest"
                                                ...
                                                <div class="img-box position-relative">
                                                    <div class="gallery_action position-absolute">
                                                        ...
                                                        <a href="{{$file->storage=='local'?asset($file->file_name):$file->file_name}}"
                                                           download data-toggle="tooltip" title="Download"><i
                                                                class="ti-download"></i></a>
                                                        <a href="{{$file->storage=='local'?asset($file->file_name):$file->file_name}}"
                                                           class="copy_link" data-toggle="tooltip" title="Copy Link"><i
                                                                class="ti-layers"></i></a>
                                                        <a data-url="{{route('setting.media-manager.delete', $file->id)}}"
                                                           class="delete_file" data-toggle="tooltip" title="Delete"><i
                                                                class="ti-trash"></i></a>
                                                    </div>
                                                    <img
