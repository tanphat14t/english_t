                            ...
                            <div class="white-box">
                                <form action="{{ isset($user) ? route('student.update') : route('student.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">Lớp
                                                    <strong class="text-danger">*</strong></label>
                                                <select class="primary_select" data-course_id="{{ @$course->id }}"
                                                    ...
                                                    <option value="male"
                                                        {{ old('gender', isset($user) ? $user->gender : '') == 'male' ? 'checked' : '' }}>
                                                        {{ __('common.Male') }}</option>
                                                    <option value="female"
                                                        {{ old('gender', isset($user) ? $user->gender : '') == 'female' ? 'checked' : '' }}>
                                                        {{ __('common.Female') }}</option>
                                                    <option value="other"
                                                        {{ old('gender', isset($user) ? $user->gender : '') == 'other' ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-35">
                                                ...
                                                <textarea class="lms_summernote" name="about" id="addAbout" cols="30" rows="10">{{ old('about', isset($user) ? $user->about : '') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field"
                                                    ...
                                                    id="addPhone" placeholder="-" type="number"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" name="email" placeholder="-"
                                                    value="{{ old('email', isset($user) ? $user->email : '') }}" id="addEmail"
                                    ...
                                    <div class="col-lg-12 text-center pt_15">
                                        <div class="d-flex justify-content-center">
                                            <button class="primary-btn semi_large2  fix-gr-bg" id="save_button_parent"
                                                ...
                                                {{ isset($user) ? __('common.Update') : __('common.Save') }}
                                                {{ __('student.Student') }}
                                            </button>
                                        </div>
                                    </div>
