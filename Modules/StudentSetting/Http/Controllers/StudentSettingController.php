            ...
            foreach ($students as $student) {
                ...
                if ($user) {
                    ...
                    if ($check) {
                        ...
                        if (UserSmsNotificationSetup('Course_Enroll_Payment', $user)) {

                            send_sms_notification($user, 'Course_Enroll_Payment', $codes);
                        }
                        ...
                        if (UserSmsNotificationSetup('Enroll_notify_Instructor', $instractor)) {
                            ...
                            send_sms_notification($instractor, 'Enroll_notify_Instructor', $codes2);
                        }
