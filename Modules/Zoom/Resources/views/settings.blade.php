                            ...
                            <div class="row mb-40  ">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>{{__('zoom.Account ID')}}<span class="required_mark">*</span> </label>
                                ...
                                <div class="col-lg-4">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>{{__('zoom.Client ID') }}<span class="required_mark">*</span></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>{{__('zoom.Client secret') }}<span class="required_mark">*</span></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
