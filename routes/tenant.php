...
Route::group(['namespace' => 'Frontend', 'middleware' => ['student']], function () {
    ...
    Route::get('my-quizzes/{id}', 'StudentController@myQuizzesDetail')->name('myQuizzesDetail');
    ...
    Route::get('flashcard/list', 'StudentController@flashcardFnc')->name('flashcard_test');
    Route::get('flashcard/detail/{id}', 'StudentController@flashcardDetailFnc')->name('flashcard_detail');

    Route::get('quizzes', 'QuizController@quizzes')->name('quizzes');
    Route::get('quiz-details/{slug}/{id}', 'QuizController@quizDetails')->name('quizDetailsView');
