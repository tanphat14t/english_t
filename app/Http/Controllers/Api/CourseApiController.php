...
class CourseApiController extends Controller
{
    ...
    {
        $courses = Course::where('type', '1')->with('user')->where('status', 1)->where('scope', 1)->latest()->get();
    ...
    public function getAllClasses()
    {
        ...
        $courses = Course::where('type', '3')->with('user', 'class')->where('scope', 1)->where('status', 1)->latest()->get();
        $response = [
            'success' => true,
            'data' => $courses,
            'total' => count($courses),
    ...
    {
        $courses = Course::where('type', '2')->with('user', 'quiz')->where('scope', 1)->where('status', 1)->latest()->get();
        $response = [
            'success' => true,
            'data' => $courses,
            'total' => count($courses),
