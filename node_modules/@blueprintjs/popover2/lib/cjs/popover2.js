...
var Popover2 = /** @class */ (function (_super) {
    ...
    function Popover2() {
        ...
        /** Popover ref handler */
        _this.popoverRef = core_1.refHandler(_this, "popoverElement", _this.props.popoverRef);
        /** Target ref handler */
        ...
        _this.renderTarget = function (_a) {
            ...
            var ref = core_1.mergeRefs(popperChildRef, _this.targetRef);
            ...
            var targetProps = tslib_1.__assign({ "aria-haspopup": "true", 
                ...
                className: classnames_1.default(className, Classes.POPOVER2_TARGET, (_b = {},
        ...
        _this.renderPopover = function (popperProps) {
            ...
            var transformOrigin = utils_1.getTransformOrigin(popperProps.placement, _this.isArrowEnabled() ? popperProps.arrowProps.style : undefined);
            ...
            var basePlacement = utils_1.getBasePlacement(popperProps.placement);
            var popoverClasses = classnames_1.default(Classes.POPOVER2, (_a = {},
        ...
        _this.handlePopoverClick = function (e) {
            ...
            var eventPopoverV1 = eventTarget.closest("." + core_1.Classes.POPOVER);
    ...
    Popover2.prototype.render = function () {
        ...
        return (React.createElement(react_popper_1.Manager, null,
            ...
            React.createElement(react_popper_1.Popper, { innerRef: this.popoverRef, placement: placement !== null && placement !== void 0 ? placement : popover2PlacementUtils_1.positionToPlacement(position), strategy: positioningStrategy, modifiers: this.getPopperModifiers() }, this.renderPopover)));
    };
    ...
    Popover2.prototype.updateDarkParent = function () {
        if (this.props.usePortal && this.state.isOpen) {
            var hasDarkParent = this.targetElement != null && this.targetElement.closest("." + core_1.Classes.DARK) != null;
    ...
    Popover2.displayName = core_1.DISPLAYNAME_PREFIX + ".Popover2";
