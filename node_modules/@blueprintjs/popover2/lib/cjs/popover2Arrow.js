...
function getArrowAngle(placement) {
    ...
    switch (utils_1.getBasePlacement(placement)) {
        case "top":
            return -90;
        case "left":
            return 180;
...
exports.Popover2Arrow = function (_a) {
    ...
    React.createElement("div", { className: Classes.POPOVER2_ARROW, "data-popper-arrow": true, ref: ref, style: tslib_1.__assign(tslib_1.__assign({}, style), getArrowReferenceOffsetStyle(placement)) },
        React.createElement("svg", { viewBox: "0 0 " + exports.POPOVER_ARROW_SVG_SIZE + " " + exports.POPOVER_ARROW_SVG_SIZE, style: { transform: "rotate(" + getArrowAngle(placement) + "deg)" } },
...
exports.Popover2Arrow.displayName = core_1.DISPLAYNAME_PREFIX + ".Popover2Arrow";
